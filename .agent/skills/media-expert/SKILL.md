---
name: media-expert
description: 音声処理、画像生成、メディア品質管理のための運用ガイド。音声フォーマット、VAD、画像生成条件、整合性検証の話題が出たらこのスキルを使う。
allowed-tools:
  - Read
---
...
- **フォーマット標準化**: [src/domain/constants.rs](file:///home/kafka/projects/vlogrs/src/domain/constants.rs) を参照。
